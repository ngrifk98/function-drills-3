...
// CODE HERE
console.log("\nSOLUTION 3");
const citiesEndingWithI = cities.filter((city) => {
...
console.log("The total price of foods with the 'rice' tag:", totalPrice);

// THE TOTAL
/* The total price of foods with the 'rice' tag: 36
*/
